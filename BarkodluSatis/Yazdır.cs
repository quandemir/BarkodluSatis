    ...
    internal class Yazdır
    {
        ...
        private void Pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            if(isyeri != null && liste!=null)
            {
                ...
                PaperSize ps58 = new PaperSize("58mm Termal", 220, kagıtuzunluk + 120);
                ...
                e.Graphics.DrawString("Toplam : " +geneltoplam.ToString("C2"), fontBaslik, Brushes.Black, new Point(5, yukseklik+40));
                e.Graphics.DrawString("------------------------------------------------------------", fontBilgi, Brushes.Black, new Point(5, yukseklik));
