        ...
        public static void RaporSayfasiRaporu(DataGridView dgv)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                list.Add(new IslemOzet
                {
                    ...
                    Iade=Convert.ToByte(dgv.Rows[i].Cells["Iade"].Value.ToString()),
                    ...
                    Gelir= Convert.ToByte(dgv.Rows[i].Cells["Gelir"].Value.ToString()),
                    Gider= Convert.ToByte(dgv.Rows[i].Cells["Gider"].Value.ToString()),
