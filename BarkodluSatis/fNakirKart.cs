...
{
    public partial class fNakirKart : Form
    {
        public fNakirKart()
        {
            InitializeComponent();
        ...
        private void tNakit_KeyDown(object sender, KeyEventArgs e)
        {
            if (tNakit.Text != "")
            {
                ...
                {
                    //başka formdan erişme var incele anlarsın 
                    Hesapla();
                }
            }
        }
        ...
        {
            //sadece sayı girilmesi için silme hariç
        ...
        private void fNakirKart_Load(object sender, EventArgs e)
        {
